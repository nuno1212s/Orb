...
public class AddSpawnLocationCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (commandSender.hasPermission("events.addSpawn")) {

            EventMain.getIns().getWarEvent().getHelper().addSpawn(((Player) commandSender).getLocation());
