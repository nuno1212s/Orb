...
public class SetSpectatorLocationCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (commandSender.hasPermission("events.setSpectator")) {

            EventMain.getIns().getWarEvent().getHelper().setSpectatorLocation(((Player) commandSender).getLocation());
